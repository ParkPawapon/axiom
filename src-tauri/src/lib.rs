...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::project_commands::generate_project_docker_compose,
            commands::project_commands::get_project_docker_status,
            commands::project_commands::start_project_docker,
            commands::project_commands::stop_project_docker,
            commands::project_commands::restart_project_docker,
